...
<!-- MENÚ PRINCIPAL -->
<nav
	class="menu navbar-expand-lg d-flex align-items-center justify-content-between px-4">
	...
	<ul class="navbar-nav mx-auto">
		...
		<li class="nav-item"><a class="nav-link" href="mensajes.jsp">Mensajes
				Navideños</a></li>
		...
		<li class="nav-item"><a class="nav-link"
			href="escribirMensajes.jsp">Mensajes Navideños</a></li>
		<li class="nav-item"><a class="nav-link text-danger"
			href="cerrarSesion.jsp">Cerrar Sesión</a></li>
		...
		<li class="nav-item"><a class="nav-link" href="mensajesAdmin.jsp">Mensajes
				Navideños</a></li>
